    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
      ...
      <div class="sidebar-scrollbar">
        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li  class="has-sub @if(request()->routeIs('home.slider')) active @elseif (request()->routeIs('add.slider')) active @elseif (request()->routeIs('home.about')) active @elseif (request()->routeIs('add.about')) active  @endif expand" >
              ...
              <ul  class="collapse show"  id="dashboard"
                ...
                <div class="sub-menu">
                    ...
                    <li  class="@if(request()->routeIs('home.slider')) active @elseif (request()->routeIs('add.slider')) active  @endif" >
                        <a class="sidenav-item-link" href="{{route('home.slider')}}">
                          <span class="nav-text">Slider</span>
                        </a>
                      </li>

                      <li  class="@if(request()->routeIs('home.about')) active @elseif (request()->routeIs('add.about')) active  @endif" >
                        <a class="sidenav-item-link" href="{{route('home.about')}}">
                          <span class="nav-text">Home About</span>
                        </a>
                      </li>

                      <li  class="{{request()->routeIs('all.brand')?'active':''}}" >
                        <a class="sidenav-item-link" href="{{route('all.brand')}}">
                          <span class="nav-text">Brand</span>
                        </a>
                      </li>

                      <li  class="{{request()->routeIs('multi.image')?'active':''}}" >
            ...
            <li  class="has-sub" >
              <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                ...
                <span class="nav-text">Kontak</span> <b class="caret"></b>
              </a>
                ...
                <div class="sub-menu">
                    ...
                    <li >
                        <a class="sidenav-item-link" href="{{route('admin.contact')}}">
                          <span class="nav-text">Profile Kontak</span>
                        </a>
                    </li>
                    <li >
